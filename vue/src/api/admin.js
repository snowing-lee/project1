...
export function getAllAdmins(){
  const res = axios.get('/api/admin/allAdmins');
  return new Promise((resolve,reject)=>{
    res
      .then((result)=>{
        if(result.status===200){
...
export function deleteAdmins(id){
  const res = axios.get('/api/admin/deleteAdmins?id='+id);
  return new Promise((resolve,reject)=>{
    res
      .then((result)=>{
        if(result.status===200){
...
export function deleteUser(id){
	const res = axios.get('/api/admin/deleteUser?id='+id);
	return new Promise((resolve,reject)=>{
		res
		.then((result)=>{
	        if(result.status===200){
...
export function getSearchAdmins(data){
  const res = axios.post('/api/admin/getSearchAdmins',data);
  // const res = axios.get('/api/admin/login');
  return new Promise((resolve,reject)=>{
    res
      .then((result)=>{
...
export function getOrdersByPage(data){
  const res = axios.post('/api/admin/ordersByPage',data);
  return new Promise((resolve,reject)=>{
    res
      .then((result)=>{
        if(result.status===200){
...
export function deleteOrder(id){
	const res = axios.get('/api/admin/deleteOrder?id='+id);
	return new Promise((resolve,reject)=>{
		res
		.then((result)=>{
	        if(result.status===200){
...
export function updateAdminss(data){
  const res = axios.post('/api/admin/updateAdminss',data);
  return new Promise((resolve,reject)=>{
    res
      .then((result)=>{
        if(result.status===200){
...
export function addAdminss(data){
  const res = axios.post('/api/admin/addAdminss',data);
  return new Promise((resolve,reject)=>{
    res
      .then((result)=>{
        if(result.status===200){
...
export function getAdminsInfo(id){
  const res = axios.get('/api/admin/getAdminsInfo?id='+id);
  return new Promise((resolve,reject)=>{
    res
      .then((result)=>{
        if(result.status===200){
...
export function deleteGoods(id){
	const res = axios.get('/api/admin/deleteGoods?id='+id);
	return new Promise((resolve,reject)=>{
		res
		.then((result)=>{
	        if(result.status===200){
